...
puts('anything 3')
post1 = Post.create(content: 'wassup', img_url: 'https://assets.reedpopcdn.com/Pokemon-Go-Wish-Granted-Header.jpg/BROK/resize/1200x1200%3E/format/jpg/quality/70/Pokemon-Go-Wish-Granted-Header.jpg', user_id: user1.id)
puts('anything 4')